...
export default function PrivacyPage() {
  return (
    <LegalShell
      eyebrow="개인정보 처리"
      title="개인정보처리방침"
      lede="Clunk가 어떤 개인정보를 어떤 목적으로 처리하고 어디에 보관하는지, 이용자가 무엇을 요구할 수 있는지를 실제로 보관하는 자리에 맞춰 정리한 것입니다."
    >
      ...
      <section aria-labelledby="privacy-items">
        ...
        <ul>
          ...
          <li>실행 기록(중복 방지 키, 지문, 종류, 수량, 상태)</li>
      ...
      <section aria-labelledby="privacy-purpose">
        ...
        <ul>
          ...
          <li>실행 횟수 계산과 중복 차감 방지</li>
          <li>구독 주문 처리, 구독 기간의 개시·종료, 환불 처리</li>
      ...
      <section aria-labelledby="privacy-retention">
        ...
        <p className="cv5-legal-note">
          <b>계정 삭제 요청 시 30일 이내</b>에 계정·작업공간·실행 기록을 파기합니다. 법령상 보존
      ...
      <section aria-labelledby="privacy-storage">
        ...
        <ul>
          ...
          <li>결제 처리는 <b>외부 결제대행사</b>에 위탁할 예정이며, 계약이 확정되면 이 자리에 상호와 위탁 범위를 적습니다. 결제 준비가 끝나기 전까지 결제 요청 자체가 만들어지지 않습니다.</li>
      ...
      <section aria-labelledby="privacy-change">
        ...
        <p className="cv5-legal-note">
          이 방침은 {LEGAL_EFFECTIVE_DATE}부터 시행합니다. 침해 신고·상담은 개인정보침해신고센터(118),

        ...
        <main className="pf-page">
            ...
            <div className="pf-cards">
              <article className="pf-card">
                ...
                <p>
                  ...
                  파종기는 프린팅 기준으로는 멀쩡하지만, 씬에 올리면 게임 사용 적합 판정을
                  통과하지 못합니다.
                </p>
              </article>
              <article className="pf-card">
          ...
          <section className="pf-section">
            ...
            <p>
              ...
              와이어프레임·단면·노멀·클레이) 컨택트 시트를 뽑고, 카드에 적힌 폴리곤 수 대비 실제
              렌더링 폴리곤 수, 동일평면 겹침 면적, 움직이는 부품의 최소 표면거리(24위상),
            ...
            <ul className="pf-list">
              ...
              <li>
                문서가 WebMCP를 &quot;읽기 전용&quot;이라고 적어 뒀는데 실제 도구에는 실행 횟수를 쓰는{" "}
          ...
          <section className="pf-section">
            ...
            <p>
              ...
              <b>자체 상한 하루 8,500(≈65장)</b>, 작업공간당 하루 8장. 상한을 넘길 호출은 실행 횟수를
              깎기 전에, 모델에 묻기 전에 거절하면서 언제 다시 열리는지 알려 줍니다.
            </p>

            <h3>가격은 경쟁사를 조사해 정했습니다</h3>
            <p>
              Meshy·Polyfork·AetherForge 세 곳의 가격표를 화면에서 직접 확인해 표로 만들고, 구독
              $10/월이라는 시장 기준선을 뽑았습니다. Maker 플랜 ₩9,900/월은 Polyfork Pro($10)와
              같은 자리이자 Meshy Pro(₩28,869)의 1/3 가격입니다. 이 과정에서 D1에 남아 있던 QA용
              데이터가 사이트가 여섯 번 말하는 값과 모순인 걸 발견해 폐기했습니다.
            </p>
            <p>
              뒤에 국내 결제대행 심사가 <b>선충전 재화와 낱개 판매를 환금성으로</b> 반려했습니다.
              결제 수단만 바꿔서는 같은 판정을 받는다고 보고, 파는 것을 <b>기간제 구독 하나</b>로
              바꿨습니다. 등급 B는 로그인만 하면 받고, A 이상은 구독이 유효한 동안 받습니다 —
              해지해도 이미 받은 파일은 그대로 남습니다.
            </p>
          </section>

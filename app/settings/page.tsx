...
export default async function SettingsPage() {
  ...
  const rows = [
    ...
    {
      label: "지금 요금제",
      // 2026-09-05: 이 자리만 "무료 (베타)"라고 적혀 있었습니다. "베타"는 쓰지 않는
      // 말이고(docs/copy-glossary.ko.md 5절), 사이드바와 대시보드는 같은 상태를
      // "무료 · 모든 기능이 열려 있습니다"라고 부릅니다. 같은 말로 맞춥니다.
      value: salesOpen ? "유료 요금제 사용 중" : "무료",
      note: salesOpen
        ? "요금제와 결제 내역은 요금 화면에서 확인합니다."
        : "모든 기능이 열려 있고, 지금은 결제를 받지 않습니다. 앞으로 적용될 요금은 요금 화면에 미리 적어 두었습니다.",
    },
    {
      label: "저장하는 것",

  ...
  try {
    ...
    await db
      .prepare(
        `INSERT INTO clunk_collaboration_threads
         (id, workspace_id, subject, asset_id, consumer_project, input_hash, target_profile_id, rule_set_id, status_json, evidence_json, created_by)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      )
      .bind(
        threadId,
    ...
    return privateJson({
      ...
      thread: {
        ...
        consumerProject: payload.consumerProject,

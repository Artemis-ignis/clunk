...
const STATIC_ROUTES: { path: string; priority: string; changefreq: string }[] = [
  ...
  { path: "/docs/quickstart", priority: "0.6", changefreq: "monthly" },
  { path: "/docs/clients", priority: "0.6", changefreq: "monthly" },
  { path: "/docs/cli", priority: "0.6", changefreq: "monthly" },
  { path: "/docs/asset-studio", priority: "0.6", changefreq: "monthly" },
  { path: "/docs/contracts", priority: "0.6", changefreq: "monthly" },
  { path: "/docs/harvest-frontier", priority: "0.5", changefreq: "monthly" },
  { path: "/docs/webmcp", priority: "0.5", changefreq: "monthly" },
  { path: "/docs/scope", priority: "0.5", changefreq: "monthly" },

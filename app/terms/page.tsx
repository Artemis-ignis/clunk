    ...
    >
      ...
      <section aria-labelledby="terms-definitions">
        ...
        <ul>
          ...
          <li><b>등급</b> — 마켓 상품에 붙는 S·A·B 표시이며, 파일에서 직접 측정한 폴리곤 수와 움직임 유무로 정합니다. <b>B 등급은 로그인만 하면 받을 수 있고, A 등급 이상은 구독이 유효한 동안 받을 수 있습니다.</b></li>
          <li><b>구독</b> — 정해진 기간 동안 마켓의 모든 등급을 받을 수 있는 <b>기간제 이용권</b>입니다.</li>
      ...
      <section aria-labelledby="terms-service">
        ...
        <ul>
          ...
          <li><b>에셋 만들기</b> — 프롬프트로 2D 이미지를, 템플릿으로 3D GLB·glTF 파일과 스프라이트 시트·애니메이션 클립을 만들고 그 결과 파일과 지문(해시)을 작업공간에 남깁니다.</li>
          <li><b>검사·수정</b> — 올리거나 만든 파일을 정해진 기준으로 검사하고, 원본은 그대로 둔 채 정리한 새 파일과 검사 증명서를 만듭니다.</li>
          <li><b>마켓</b> — 공개 조건을 갖춘 마켓 상품의 열람과 다운로드를 제공합니다. 낱개 구매는 없으며, A 등급 이상은 제7조의 구독이 유효한 동안 받을 수 있습니다.</li>
      ...
      <section aria-labelledby="terms-purchase">
        ...
        <p>
          Clunk가 파는 것은 <b>기간제 구독 하나</b>입니다. 낱개 판매와 선불 충전은 하지 않습니다.
          구독이 유효한 동안 마켓의 모든 등급을 횟수 제한 없이 받을 수 있고, B 등급은 구독하지
          않아도 로그인만 하면 받을 수 있습니다.
        </p>
        <p>

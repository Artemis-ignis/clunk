...
export default function TermsPage() {
  return (
    <LegalShell
      eyebrow="이용 조건"
      title="이용약관"
      lede="Clunk(이하 “서비스”)가 제공하는 게임 에셋 만들기·검사·마켓 기능의 이용 조건입니다. 운영자(아르테미스)의 사업자 등록은 완료되어 있으며, 지금은 무료 베타 기간이라 유상 거래는 하지 않습니다."
    >
      ...
      <section aria-labelledby="terms-service">
        ...
        <ul>
          <li><b>에셋 만들기</b> — 문장과 참고 이미지로 2D 이미지를, 코드로 3D GLB·glTF 파일을 만들고 그 결과 파일과 지문(해시)을 작업공간에 남깁니다.</li>
      ...
      <section aria-labelledby="terms-credit">
        ...
        <ul>
          ...
          <li>지금은 무료 베타라 유료로 파는 크레딧도, 정기 결제(구독) 상품도 없습니다. 유상 판매를 시작할 때에는 금액·수량·유효기간을 <a href="/pricing">요금 안내</a>와 이 약관에 먼저 적습니다.</li>
        </ul>
      </section>
      ...
      <section aria-labelledby="terms-purchase">
        ...
        <p className="cv5-legal-note">
          ...
          겸합니다. 단, 지금은 무료 베타라 유상 거래를 하지 않습니다.
        </p>
      </section>

...
export const metadata = createPageMetadata({
  ...
  description: "Clunk가 직접 만든 가벼운 3D 모델과 이어붙는 2D 텍스처. 폴리곤 수와 용량은 파일에서 측정한 값입니다. 베타 기간에는 모든 에셋이 무료입니다.",
  path: "/marketplace",
});
          ...
          <header className={styles.browseHead} data-band="hero" data-snap-section="hero">
            <div className="cv5-frame">
              ...
              <p className={styles.browseLede}>
                에셋을 직접 확인하고 필요한 것만 받으세요. 폴리곤 수와 용량은 파일에서 측정한 값입니다. 모든 에셋은 게임·앱·의뢰 작업에 상업적으로 쓸 수 있고 출처 표기가 필요 없습니다.
                {salesOpen ? "" : " 베타 기간에는 모든 에셋이 무료입니다."}
              </p>
              {/* 키트는 이 목록의 탭이 아니라 자기 화면을 갖는다. 여기서는 그 길만 말한다. */}
              <p className={styles.browseKits}>
                한 장면을 통째로 꾸미려면 <Link href="/kits">키트</Link>에서 한 벌씩 받으세요.
              </p>
            </div>
          </header>

...
export const PLAYGROUND_TOOLS: PlaygroundTool[] = [
  {
    ...
    lines: [
      ...
      { kind: "json", text: "  \"inputHash\": \"9f2ab4cf4c750a711c431266e3c7d99d…c7043f\"," },
      { kind: "json", text: "  \"resultDigest\": \"c074c9454c7b221e66d42ea90aa0c375…e7e997\"," },
      { kind: "json", text: "  \"report\": {" },
      { kind: "json", text: "    \"byteLength\": 1173772," },
      { kind: "json", text: "    \"metrics\": { \"triangleCount\": 34928, \"vertexCount\": 19200," },
  ...
  },
  {
    ...
    lines: [
      ...
      { kind: "json", text: "    \"breakdown\": { \"format\": 100, \"scene\": 79, \"geometry\": 97," },
  ...
  },
  {
    ...
    lines: [
      ...
      { kind: "json", text: "  \"inputHash\":  \"9f2ab4cf4c750a711c431266e3c7d99d…c7043f\"," },
      { kind: "json", text: "  \"outputHash\": \"be4610c3e378f2f9799eff6312f6ab9d…8c8151\"," },
      ...
      { kind: "json", text: "  \"after\":  { \"nodeCount\": 15, \"materialCount\": 7,  \"score\": 96 }" },
      { kind: "json", text: "}" },
      { kind: "note", text: "# 빈 노드 12개 중 8개만 지웁니다 · 나머지 4개는 extras를 달고 있어 사람 판단으로 넘깁니다" },
      { kind: "ok", text: "재생 완료 · 실측 응답" },
    ],
  },
  {
    ...
    lines: [
      ...
      { kind: "json", text: "    \"passportId\": \"passport-9f2ab4cf4c75-be4610c3e378\"," },
      { kind: "json", text: "    \"coreVersion\": \"0.2.0\"," },
      { kind: "json", text: "    \"sourceHash\": \"9f2ab4cf4c750a711c431266e3c7d99d…c7043f\"," },
      { kind: "json", text: "    \"outputHash\": \"be4610c3e378f2f9799eff6312f6ab9d…8c8151\"," },
      { kind: "json", text: "    \"sourceInspectionDigest\": \"c074c9454c7b221e…e7e997\"," },
      { kind: "json", text: "    \"outputInspectionDigest\": \"85ddd028e774208f…2985d5\"," },
      { kind: "json", text: "    \"before\": { \"score\": 95 }," },
      { kind: "json", text: "    \"after\":  { \"score\": 96 }" },
      { kind: "json", text: "  }" },
      { kind: "json", text: "}" },

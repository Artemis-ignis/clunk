...
export const PLAYGROUND_TOOLS: PlaygroundTool[] = [
  {
    ...
    lines: [
      ...
      { kind: "json", text: "  \"resultDigest\": \"b116172bc7255c01a82826020868a58c…303a6b\"," },
  ...
  },
  {
    ...
    lines: [
      ...
      { kind: "json", text: "    \"outputHash\": \"4368b41991a64f010713da589b1cb329…70f275\"," },
      { kind: "json", text: "    \"sourceInspectionDigest\": \"b116172bc7255c01…303a6b\"," },
      { kind: "json", text: "    \"outputInspectionDigest\": \"c64b9ff20a5a5a0a…2efe73\"," },

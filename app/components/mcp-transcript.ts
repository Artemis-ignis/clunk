...
export const PLAYGROUND_TOOLS: PlaygroundTool[] = [
  {
    ...
    lines: [
      ...
      { kind: "json", text: "  \"resultDigest\": \"bfc910e862b639dac89888a126565d93…e3eb09\"," },
  ...
  },
  {
    ...
    lines: [
      ...
      { kind: "json", text: "    \"outputHash\": \"4368b41991a64f010713da589b1cb329…70f275\"," },
      { kind: "json", text: "    \"sourceInspectionDigest\": \"bfc910e862b639da…e3eb09\"," },
      { kind: "json", text: "    \"outputInspectionDigest\": \"955ca2d3014f508e…f2276d\"," },

...
export const PLAYGROUND_TOOLS: PlaygroundTool[] = [
  {
    ...
    lines: [
      ...
      { kind: "json", text: "  \"resultDigest\": \"11a617469271ae806381501465145abf…fb2b70\"," },
  ...
  },
  {
    ...
    lines: [
      ...
      { kind: "json", text: "    \"outputHash\": \"be4610c3e378f2f9799eff6312f6ab9d…8c8151\"," },
      { kind: "json", text: "    \"sourceInspectionDigest\": \"11a617469271ae80…fb2b70\"," },
      { kind: "json", text: "    \"outputInspectionDigest\": \"565a16c206618723…9181d3\"," },

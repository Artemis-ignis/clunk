...
export const COLLABORATION_CONTRACT = {
  ...
  assetEvidenceRef: "clunk.asset-evidence-ref.v1 stores inputHash/resultDigest/byteLength/coreBuildId/ruleSetId/ruleSetVersion plus optional profileId/analysisId; CURRENT means producer-supplied fresh reinspection, while STALE or UNKNOWN is valid evidence but never current approval; malformed or mismatched provenance is INVALID",

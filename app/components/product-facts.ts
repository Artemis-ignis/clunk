...
export const COLLABORATION_CONTRACT = {
  ...
  assetEvidenceRef: "clunk.asset-evidence-ref.v1 stores inputHash/resultDigest/byteLength/coreBuildId/ruleSetId/ruleSetVersion plus optional profileId/analysisId; every fresh HF submission must also carry inspectionRunId on assetInspections[] and the declared targetProfileId; CURRENT means producer-supplied fresh reinspection, while STALE or UNKNOWN is valid evidence but never current approval; malformed or mismatched provenance is INVALID",

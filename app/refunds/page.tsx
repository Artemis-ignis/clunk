  ...
  return (
    ...
    >
      ...
      <section aria-labelledby="refunds-scope">
        ...
        <p>
          에셋을 낱개로 사고파는 거래, 미리 충전해 두었다가 쓰는 재화, 무엇이 나올지 정해지지 않은
          상품은 제공하지 않습니다. 실행 횟수는 구독에 포함된 사용 한도일 뿐 따로 팔지 않으므로
          그 자체를 환불하는 거래도 없습니다. B 등급 에셋은 로그인만 하면 받을 수 있어 결제와 무관합니다.
        </p>
      </section>

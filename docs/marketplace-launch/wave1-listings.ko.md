...
> **상태(2026-08-31, 마스터 지시): 판매 개시 보류.** 사업자 등록은 완료(아르테미스,
> 361-02-03814)됐으나 **통신판매업 신고가 완료될 때까지 크레딧·에셋 유상 판매를
> 개시하지 않는다.** 이 문서의 모든 준비 작업(재고·preview·렌더·등록 절차)은
> "준비 완료 → 신고 완료 시 즉시 개시" 상태를 만들기 위한 것이다. 신고 완료 전에는
> 팩 ACTIVE 전환·listing PUBLISHED 전환·Stripe 시크릿 주입을 하지 않는다.
